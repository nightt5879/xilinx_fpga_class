...
module AESL_automem_out_channels_ch3 (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.yuv_filter.autotvin_out_channels_ch3.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.yuv_filter.autotvout_out_channels_ch3.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 22;
parameter DEPTH = 32'd 2457600;
parameter DLY = 0.1;
