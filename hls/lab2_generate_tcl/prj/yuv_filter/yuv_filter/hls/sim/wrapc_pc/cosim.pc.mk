...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := E:/xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=E:/xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L E:/xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/yuv_filter_test.c_pre.c.tb.o : yuv_filter_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling yuv_filter_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/image_aux.c_pre.c.tb.o : image_aux.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling image_aux.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/yuv_filter.c_pre.c.tb.o : yuv_filter.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling yuv_filter.c_pre.c.tb.c" $(AVE_DIR_DLOG)
