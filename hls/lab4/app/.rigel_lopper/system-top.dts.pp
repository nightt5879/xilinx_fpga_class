# 0 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "bug_test.bit.bin";
  clocking1: clocking1 {
  ...
  audio_codec_ctrl_0: audio_codec_ctrl@43c00000 {
   compatible = "xlnx,audio-codec-ctrl-1.0";
   xlnx,slv-awidth = <32>;
   xlnx,rable = <0>;
   xlnx,ip-name = "audio_codec_ctrl";
   reg = <0x43c00000 0x10000>;
   clocks = <&clkc 15>;
   xlnx,codec-address = "11";
   xlnx,dphase-timeout = <8>;
   xlnx,num-reg = <1>;
  ...
  fir_0: fir@40000000 {
   ...
   xlnx,s-axi-fir-io-addr-width = <6>;
   xlnx,ii = <69>;
   xlnx,machine = <64>;
   interrupt-parent = <&intc>;
   xlnx,rable = <0>;
   ...
   clocks = <&clkc 15>;
   xlnx,s-axi-fir-io-data-width = <32>;
   xlnx,clk-period = <10>;
   xlnx,edk-iptype = "PERIPHERAL";
   status = "okay";
   clock-names = "ap_clk";
...
# 4 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
...
# 5 "E:\\robot\\project\\xilinx_fpga_class\\hls\\lab4\\app\\.rigel_lopper_temp_platform\\bug_test\\hw\\sdt\\system-top.dts" 2
/ {
 board = "pynq-z2";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &fir_0 0x40000000 0x10000>,
         <0x40010000 &fir_1 0x40010000 0x10000>,
         <0x41200000 &axi_gpio_0 0x41200000 0x10000>,
         <0x43c00000 &audio_codec_ctrl_0 0x43c00000 0x10000>,
