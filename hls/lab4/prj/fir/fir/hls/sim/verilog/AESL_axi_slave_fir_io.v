...
module AESL_axi_slave_fir_io (
    clk,
    reset,
    TRAN_s_axi_fir_io_AWADDR,
    TRAN_s_axi_fir_io_AWVALID,
    TRAN_s_axi_fir_io_AWREADY,
    TRAN_s_axi_fir_io_WVALID,
    TRAN_s_axi_fir_io_WREADY,
    TRAN_s_axi_fir_io_WDATA,
    TRAN_s_axi_fir_io_WSTRB,
    TRAN_s_axi_fir_io_ARADDR,
    TRAN_s_axi_fir_io_ARVALID,
    TRAN_s_axi_fir_io_ARREADY,
    TRAN_s_axi_fir_io_RVALID,
    TRAN_s_axi_fir_io_RREADY,
    TRAN_s_axi_fir_io_RDATA,
    TRAN_s_axi_fir_io_RRESP,
    TRAN_s_axi_fir_io_BVALID,
    TRAN_s_axi_fir_io_BREADY,
    TRAN_s_axi_fir_io_BRESP,
    TRAN_fir_io_write_data_finish,
    TRAN_fir_io_read_data_finish,
    TRAN_fir_io_start_in,
    TRAN_fir_io_idle_out,
    TRAN_fir_io_ready_out,
    TRAN_fir_io_ready_in,
    TRAN_fir_io_done_out,
    TRAN_fir_io_write_start_in   ,
    TRAN_fir_io_write_start_finish,
    TRAN_fir_io_interrupt,
    TRAN_fir_io_transaction_done_in
    );
...
parameter x_data_in_addr = 32;
parameter y_data_out_addr = 16;
parameter y_valid_out_addr = 20;
parameter STATUS_ADDR = 0;

output [ADDR_WIDTH - 1 : 0] TRAN_s_axi_fir_io_AWADDR;
output  TRAN_s_axi_fir_io_AWVALID;
input  TRAN_s_axi_fir_io_AWREADY;
output  TRAN_s_axi_fir_io_WVALID;
input  TRAN_s_axi_fir_io_WREADY;
output [DATA_WIDTH - 1 : 0] TRAN_s_axi_fir_io_WDATA;
output [DATA_WIDTH/8 - 1 : 0] TRAN_s_axi_fir_io_WSTRB;
output [ADDR_WIDTH - 1 : 0] TRAN_s_axi_fir_io_ARADDR;
output  TRAN_s_axi_fir_io_ARVALID;
input  TRAN_s_axi_fir_io_ARREADY;
input  TRAN_s_axi_fir_io_RVALID;
output  TRAN_s_axi_fir_io_RREADY;
input [DATA_WIDTH - 1 : 0] TRAN_s_axi_fir_io_RDATA;
input [2 - 1 : 0] TRAN_s_axi_fir_io_RRESP;
input  TRAN_s_axi_fir_io_BVALID;
output  TRAN_s_axi_fir_io_BREADY;
input [2 - 1 : 0] TRAN_s_axi_fir_io_BRESP;
output TRAN_fir_io_write_data_finish;
output TRAN_fir_io_read_data_finish;
input     clk;
input     reset;
input     TRAN_fir_io_start_in;
output    TRAN_fir_io_done_out;
output    TRAN_fir_io_ready_out;
input     TRAN_fir_io_ready_in;
output    TRAN_fir_io_idle_out;
input  TRAN_fir_io_write_start_in   ;
output TRAN_fir_io_write_start_finish;
input     TRAN_fir_io_interrupt;
input     TRAN_fir_io_transaction_done_in;
...
//=================== signal connection ==============
assign TRAN_s_axi_fir_io_AWADDR = AWADDR_reg;
assign TRAN_s_axi_fir_io_AWVALID = AWVALID_reg;
assign TRAN_s_axi_fir_io_WVALID = WVALID_reg;
assign TRAN_s_axi_fir_io_WDATA = WDATA_reg;
assign TRAN_s_axi_fir_io_WSTRB = WSTRB_reg;
assign TRAN_s_axi_fir_io_ARADDR = ARADDR_reg;
assign TRAN_s_axi_fir_io_ARVALID = ARVALID_reg;
assign TRAN_s_axi_fir_io_RREADY = RREADY_reg;
assign TRAN_s_axi_fir_io_BREADY = BREADY_reg;
assign TRAN_fir_io_write_start_finish = AESL_write_start_finish;
assign TRAN_fir_io_done_out = AESL_done_index_reg;
assign TRAN_fir_io_ready_out = AESL_ready_out_index_reg;
assign TRAN_fir_io_idle_out = AESL_idle_index_reg;
assign TRAN_fir_io_read_data_finish = 1 & y_read_data_finish;
assign TRAN_fir_io_write_data_finish = 1 & x_write_data_finish;
always @(TRAN_fir_io_ready_in or ready_initial) 
begin
    AESL_ready_reg <= TRAN_fir_io_ready_in | ready_initial;
end
...
//=======================one single write operate======================
    ...
    while (!(aw_flag && w_flag)) begin
        @(posedge clk);
        if (aw_flag != 1)
            aw_flag = TRAN_s_axi_fir_io_AWREADY & AWVALID_reg;
        if (w_flag != 1)
            w_flag = TRAN_s_axi_fir_io_WREADY & WVALID_reg;
        AWVALID_reg <= !aw_flag;
        WVALID_reg <= !w_flag;
    end

    BREADY_reg <= 1;
    while (TRAN_s_axi_fir_io_BVALID != 1) begin
        //wait for response 
        @(posedge clk);
    end
    @(posedge clk);
    BREADY_reg <= 0;
    if (TRAN_s_axi_fir_io_BRESP === 2'b00) begin
        wresp = 1;
...
//=======================one single read operate======================
    ARADDR_reg <= raddr;
    ARVALID_reg <= 1;
    while (TRAN_s_axi_fir_io_ARREADY !== 1) begin
        @(posedge clk);
    end
    @(posedge clk);
    ARVALID_reg <= 0;
    RREADY_reg <= 1;
    while (TRAN_s_axi_fir_io_RVALID !== 1) begin
        //wait for response 
        @(posedge clk);
    end
    @(posedge clk);
    RDATA_result  <= TRAN_s_axi_fir_io_RDATA;
    RREADY_reg <= 0;
    if (TRAN_s_axi_fir_io_RRESP === 2'b00 ) begin
        rresp <= 1;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (TRAN_fir_io_start_in === 1) begin
            x_write_data_finish <= 0;
        end
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (write_start_count >= 68) begin
            write_start_run_flag <= 0; 
        end
        else if (TRAN_fir_io_write_start_in === 1) begin
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (TRAN_fir_io_transaction_done_in === 1) begin
            y_read_data_finish <= 0;
            read_y_count = 0; 
        end
...
initial begin : write_y_file_proc 
  ...
  while(1) begin 
      @(posedge clk);
      while (y_read_data_finish !== 1 || TRAN_fir_io_transaction_done_in === 1) begin
          @(posedge clk);
      end
      # 0.1;
      fp = $fopen(`TV_OUT_y, "a"); 
      ...
      $fclose(fp); 
      while (TRAN_fir_io_start_in !== 1) begin
          @(posedge clk);
      end
  end 
end 
