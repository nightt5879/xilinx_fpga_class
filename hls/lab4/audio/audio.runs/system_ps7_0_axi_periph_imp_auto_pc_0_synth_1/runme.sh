...
HD_PWD='E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.runs/system_ps7_0_axi_periph_imp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps7_0_axi_periph_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps7_0_axi_periph_imp_auto_pc_0.tcl
