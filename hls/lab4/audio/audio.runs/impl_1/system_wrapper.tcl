namespace eval ::optrace {
  variable script "E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.cache/wt [current_project]
  set_property parent.project_path E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.xpr [current_project]
  set_property ip_repo_paths {
  e:/robot/project/xilinx_fpga_class/hls/lab4/ip_repo
  E:/robot/project/xilinx_fpga_class/hls/lab4_zynq_z2/prj/fir/fir/hls/impl/ip
} [current_project]
  update_ip_catalog
  set_property ip_output_repo E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.srcs/sources_1/bd/system/system.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc E:/robot/project/xilinx_fpga_class/hls/lab4/audio/audio.srcs/constrs_1/imports/lab4_zynq_z2/pynq_z2_audio_constraints.xdc
