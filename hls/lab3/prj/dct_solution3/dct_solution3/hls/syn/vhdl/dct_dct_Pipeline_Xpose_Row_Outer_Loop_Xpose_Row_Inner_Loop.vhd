...
attribute shreg_extract : string;
    ...
    signal indvar_flatten29_fu_48 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
...
begin
    ...
    indvar_flatten29_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln64_fu_97_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    ...
                    indvar_flatten29_fu_48 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln64_1_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten29_load) + unsigned(ap_const_lv7_1));
    ...
    ap_sig_allocacmp_indvar_flatten29_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, indvar_flatten29_fu_48)
    begin
    ...
    icmp_ln64_fu_97_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten29_load = ap_const_lv7_40) else "0";
