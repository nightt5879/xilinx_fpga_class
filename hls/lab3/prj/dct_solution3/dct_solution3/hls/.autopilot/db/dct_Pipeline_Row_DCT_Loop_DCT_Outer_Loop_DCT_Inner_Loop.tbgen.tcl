set moduleName dct_Pipeline_Row_DCT_Loop_DCT_Outer_Loop_DCT_Inner_Loop
set isTopModule 0
...
set cdfgNum 9
set C_modelName {dct_Pipeline_Row_DCT_Loop_DCT_Outer_Loop_DCT_Inner_Loop}
...
set portList { 
	...
	{ row_outbuf_we0 sc_out sc_logic 1 signal 0 } 
	{ row_outbuf_d0 sc_out sc_lv 16 signal 0 } 
	{ buf_2d_in_address0 sc_out sc_lv 6 signal 1 } 
	{ buf_2d_in_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf_2d_in_q0 sc_in sc_lv 16 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "dct_Pipeline_Row_DCT_Loop_DCT_Outer_Loop_DCT_Inner_Loop",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "Row_DCT_Loop_DCT_Outer_Loop_DCT_Inner_Loop", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	dct_Pipeline_Row_DCT_Loop_DCT_Outer_Loop_DCT_Inner_Loop {
...
set Spec2ImplPortList { 
	...
	buf_2d_in { ap_memory {  { buf_2d_in_address0 mem_address 1 6 }  { buf_2d_in_ce0 mem_ce 1 1 }  { buf_2d_in_q0 mem_dout 0 16 } } }
