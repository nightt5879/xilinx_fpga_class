...
reg    ap_ready_int;
wire   [2:0] dct_1d_dct_coeff_table_02_address0;
wire   [13:0] dct_1d_dct_coeff_table_02_q0;
wire   [2:0] dct_1d_dct_coeff_table_13_address0;
wire  signed [14:0] dct_1d_dct_coeff_table_13_q0;
wire   [2:0] dct_1d_dct_coeff_table_24_address0;
wire   [14:0] dct_1d_dct_coeff_table_24_q0;
wire   [2:0] dct_1d_dct_coeff_table_35_address0;
wire  signed [14:0] dct_1d_dct_coeff_table_35_q0;
wire   [2:0] dct_1d_dct_coeff_table_46_address0;
wire   [14:0] dct_1d_dct_coeff_table_46_q0;
wire   [2:0] dct_1d_dct_coeff_table_57_address0;
wire  signed [14:0] dct_1d_dct_coeff_table_57_q0;
wire   [2:0] dct_1d_dct_coeff_table_68_address0;
wire   [14:0] dct_1d_dct_coeff_table_68_q0;
wire   [2:0] dct_1d_dct_coeff_table_79_address0;
wire  signed [14:0] dct_1d_dct_coeff_table_79_q0;
...
wire   [2:0] trunc_ln61_fu_369_p1;
reg   [2:0] trunc_ln61_reg_618;
reg   [2:0] trunc_ln61_reg_618_pp0_iter1_reg;
reg   [2:0] trunc_ln61_reg_618_pp0_iter2_reg;
reg   [2:0] trunc_ln61_reg_618_pp0_iter3_reg;
reg   [2:0] trunc_ln61_reg_618_pp0_iter4_reg;
reg   [2:0] trunc_ln61_reg_618_pp0_iter5_reg;
reg   [2:0] trunc_ln61_reg_618_pp0_iter6_reg;
wire   [0:0] icmp_ln39_fu_409_p2;
reg   [0:0] icmp_ln39_reg_703;
reg   [0:0] icmp_ln61_reg_708;
reg  signed [15:0] buf_2d_in_0_load_reg_712;
reg  signed [15:0] buf_2d_in_2_load_reg_717;
reg  signed [15:0] buf_2d_in_4_load_reg_722;
reg  signed [15:0] buf_2d_in_6_load_reg_727;
reg   [13:0] coeff_reg_752;
reg  signed [14:0] coeff_2_reg_762;
reg  signed [14:0] coeff_4_reg_772;
reg  signed [14:0] coeff_6_reg_782;
wire   [28:0] mul_ln46_2_fu_492_p2;
reg  signed [28:0] mul_ln46_2_reg_802;
wire   [28:0] mul_ln46_4_fu_498_p2;
reg  signed [28:0] mul_ln46_4_reg_807;
wire   [28:0] mul_ln46_6_fu_504_p2;
reg  signed [28:0] mul_ln46_6_reg_812;
...
reg  signed [28:0] add_ln46_1_reg_822;
reg  signed [28:0] add_ln46_1_reg_822_pp0_iter5_reg;
wire  signed [28:0] grp_fu_576_p3;
reg  signed [28:0] add_ln46_3_reg_827;
wire   [28:0] grp_fu_561_p3;
(* use_dsp48 = "no" *) wire   [28:0] add_ln46_6_fu_510_p2;
reg   [28:0] add_ln46_6_reg_837;
reg   [15:0] trunc_ln_reg_842;
reg   [0:0] ap_phi_mux_icmp_ln394_phi_fu_316_p4;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln61_fu_373_p1;
wire   [63:0] zext_ln39_fu_385_p1;
wire   [63:0] zext_ln46_2_fu_549_p1;
reg   [5:0] indvar_flatten1_fu_80;
wire   [5:0] add_ln61_1_fu_403_p2;
...
reg    dct_1d_dct_coeff_table_02_ce0_local;
reg    dct_1d_dct_coeff_table_13_ce0_local;
reg    dct_1d_dct_coeff_table_24_ce0_local;
reg    dct_1d_dct_coeff_table_35_ce0_local;
reg    dct_1d_dct_coeff_table_46_ce0_local;
reg    dct_1d_dct_coeff_table_57_ce0_local;
reg    dct_1d_dct_coeff_table_68_ce0_local;
reg    dct_1d_dct_coeff_table_79_ce0_local;
reg    row_outbuf_i_we0_local;
reg    row_outbuf_i_ce0_local;
wire   [3:0] add_ln61_fu_347_p2;
wire   [13:0] mul_ln46_2_fu_492_p1;
wire  signed [28:0] add_ln46_6_fu_510_p0;
wire   [28:0] grp_fu_583_p3;
(* use_dsp48 = "no" *) wire   [28:0] add_ln46_2_fu_514_p2;
wire   [28:0] add_ln46_7_fu_518_p2;
wire   [5:0] tmp_fu_533_p3;
wire   [5:0] zext_ln46_1_fu_540_p1;
wire   [5:0] add_ln46_8_fu_543_p2;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [28:0] mul_ln46_2_fu_492_p10;
...
dct_mac_muladd_16s_15s_29s_29_4_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
mac_muladd_16s_15s_29s_29_4_1_U13(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(buf_2d_in_1_q0),
...
dct_mac_muladd_16s_15s_29ns_29_4_1 #(
    ...
    .din2_WIDTH( 29 ),
    .dout_WIDTH( 29 ))
mac_muladd_16s_15s_29ns_29_4_1_U17(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        trunc_ln_reg_842 <= {{add_ln46_7_fu_518_p2[28:13]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln61_fu_415_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_02_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_02_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_13_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_13_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_24_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_24_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_35_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_35_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_46_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_46_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_57_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_57_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_68_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_68_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dct_1d_dct_coeff_table_79_ce0_local = 1'b1;
    end else begin
        dct_1d_dct_coeff_table_79_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1))) begin
        row_outbuf_i_we0_local = 1'b1;
    end else begin
        row_outbuf_i_we0_local = 1'b0;
    end
end
...
assign add_ln46_2_fu_514_p2 = ($signed(add_ln46_1_reg_822_pp0_iter5_reg) + $signed(add_ln46_reg_817_pp0_iter5_reg));

assign add_ln46_6_fu_510_p0 = grp_fu_583_p3;

assign add_ln46_6_fu_510_p2 = ($signed(add_ln46_6_fu_510_p0) + $signed(add_ln46_3_reg_827));

assign add_ln46_7_fu_518_p2 = (add_ln46_6_reg_837 + add_ln46_2_fu_514_p2);

assign add_ln46_8_fu_543_p2 = (tmp_fu_533_p3 + zext_ln46_1_fu_540_p1);

assign add_ln61_1_fu_403_p2 = (ap_sig_allocacmp_indvar_flatten1_load + 6'd1);

assign add_ln61_fu_347_p2 = (ap_sig_allocacmp_i2_load + 4'd1);
...
always @ (*) begin
    ap_condition_645 = ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln61_reg_708 == 1'd0));
end
...
assign buf_2d_in_0_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_0_ce0 = buf_2d_in_0_ce0_local;

assign buf_2d_in_1_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_1_ce0 = buf_2d_in_1_ce0_local;

assign buf_2d_in_2_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_2_ce0 = buf_2d_in_2_ce0_local;

assign buf_2d_in_3_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_3_ce0 = buf_2d_in_3_ce0_local;

assign buf_2d_in_4_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_4_ce0 = buf_2d_in_4_ce0_local;

assign buf_2d_in_5_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_5_ce0 = buf_2d_in_5_ce0_local;

assign buf_2d_in_6_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_6_ce0 = buf_2d_in_6_ce0_local;

assign buf_2d_in_7_address0 = zext_ln61_fu_373_p1;

assign buf_2d_in_7_ce0 = buf_2d_in_7_ce0_local;

assign dct_1d_dct_coeff_table_02_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_13_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_24_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_35_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_46_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_57_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_68_address0 = zext_ln39_fu_385_p1;

assign dct_1d_dct_coeff_table_79_address0 = zext_ln39_fu_385_p1;

assign grp_fu_561_p2 = 29'd4096;

assign i_fu_361_p3 = ((ap_phi_mux_icmp_ln394_phi_fu_316_p4[0:0] == 1'b1) ? add_ln61_fu_347_p2 : ap_sig_allocacmp_i2_load);

assign icmp_ln39_fu_409_p2 = ((k_fu_397_p2 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln61_fu_415_p2 = ((ap_sig_allocacmp_indvar_flatten1_load == 6'd63) ? 1'b1 : 1'b0);

assign k_fu_397_p2 = (select_ln57_fu_353_p3 + 4'd1);

assign mul_ln46_2_fu_492_p1 = mul_ln46_2_fu_492_p10;

assign mul_ln46_2_fu_492_p10 = coeff_reg_752;

assign row_outbuf_i_address0 = zext_ln46_2_fu_549_p1;

assign row_outbuf_i_ce0 = row_outbuf_i_ce0_local;

assign row_outbuf_i_d0 = trunc_ln_reg_842;

assign row_outbuf_i_we0 = row_outbuf_i_we0_local;

assign select_ln57_fu_353_p3 = ((ap_phi_mux_icmp_ln394_phi_fu_316_p4[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_k3_load);

assign tmp_fu_533_p3 = {{trunc_ln61_reg_618_pp0_iter6_reg}, {3'd0}};

assign trunc_ln61_fu_369_p1 = i_fu_361_p3[2:0];

assign zext_ln39_fu_385_p1 = select_ln57_fu_353_p3;

assign zext_ln46_1_fu_540_p1 = select_ln57_reg_613_pp0_iter6_reg;

assign zext_ln46_2_fu_549_p1 = add_ln46_8_fu_543_p2;

assign zext_ln61_fu_373_p1 = i_fu_361_p3;
