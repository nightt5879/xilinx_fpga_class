# 1 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "E:/vitis/Vitis/2024.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h" 1
# 263 "E:/vitis/Vitis/2024.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c" 2
# 27 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
# 1 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.h" 1
# 41 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.h"
...
# 1 "E:/robot/project/xilinx_fpga_class/hls/lab2/image_aux.h" 1
# 32 "E:/robot/project/xilinx_fpga_class/hls/lab2/image_aux.h"
...
# 49 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.h" 2
...
# 28 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c" 2
...
# 37 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
...
RGB2YUV_LOOP_X:
   for (x=0; x<width; x++) {
#line 14 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution2/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 75 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"

#pragma HLS loop_tripcount min=200 max=1920
RGB2YUV_LOOP_Y:
      for (y=0; y<height; y++) {
#line 15 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution2/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 78 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
...
YUV2RGB_LOOP_X:
   for (x=0; x<width; x++) {
#line 16 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution2/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 115 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
...
YUV_SCALE_LOOP_X:
   for (x=0; x<width; x++) {
#line 17 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution2/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 155 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"

#pragma HLS loop_tripcount min=200 max=1920
YUV_SCALE_LOOP_Y:
      for (y=0; y<height; y++) {
#line 18 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution2/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 158 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
