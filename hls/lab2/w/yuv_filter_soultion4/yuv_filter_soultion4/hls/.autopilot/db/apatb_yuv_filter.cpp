...
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.yuv_filter.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.yuv_filter.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.yuv_filter.autotvout_gmem.dat"
...
{
  hls::sim::Byte<4> __xlx_offset_byte_param_in_channels_ch1;
  ...
  port0.param = &__xlx_offset_byte_param_in_channels_ch1;

  hls::sim::Byte<4> __xlx_offset_byte_param_in_channels_ch2;
  ...
  port1.param = &__xlx_offset_byte_param_in_channels_ch2;

  hls::sim::Byte<4> __xlx_offset_byte_param_in_channels_ch3;
  ...
  port2.param = &__xlx_offset_byte_param_in_channels_ch3;

  hls::sim::Byte<4> __xlx_offset_byte_param_in_width;
  ...
  port3.param = &__xlx_offset_byte_param_in_width;

  hls::sim::Byte<4> __xlx_offset_byte_param_in_height;
  ...
  port4.param = &__xlx_offset_byte_param_in_height;

  hls::sim::Byte<4> __xlx_offset_byte_param_out_channels_ch1;
  ...
  port5.param = &__xlx_offset_byte_param_out_channels_ch1;

  hls::sim::Byte<4> __xlx_offset_byte_param_out_channels_ch2;
  ...
  port6.param = &__xlx_offset_byte_param_out_channels_ch2;

  hls::sim::Byte<4> __xlx_offset_byte_param_out_channels_ch3;
  ...
  port7.param = &__xlx_offset_byte_param_out_channels_ch3;

  hls::sim::Byte<4> __xlx_offset_byte_param_out_width;
  ...
  port8.param = &__xlx_offset_byte_param_out_width;

  hls::sim::Byte<4> __xlx_offset_byte_param_out_height;
  ...
  port9.param = &__xlx_offset_byte_param_out_height;
  ...
  port10.param = &__xlx_apatb_param_Y_scale;
  ...
  port11.param = &__xlx_apatb_param_U_scale;
  ...
  port12.param = &__xlx_apatb_param_V_scale;
  ...
  port13.param = { __xlx_apatb_param_in_channels_ch1, __xlx_apatb_param_in_channels_ch2, __xlx_apatb_param_in_channels_ch3, __xlx_apatb_param_in_width, __xlx_apatb_param_in_height, __xlx_apatb_param_out_channels_ch1, __xlx_apatb_param_out_channels_ch2, __xlx_apatb_param_out_channels_ch3, __xlx_apatb_param_out_width, __xlx_apatb_param_out_height };
  port13.mname = { "in_channels_ch1", "in_channels_ch2", "in_channels_ch3", "in_width", "in_height", "out_channels_ch1", "out_channels_ch2", "out_channels_ch3", "out_width", "out_height" };
  port13.nbytes = { 2457600, 2457600, 2457600, 0, 0, 2457600, 2457600, 2457600, 0, 0 };
  ...
  __xlx_offset_byte_param_in_channels_ch1 = port13.offset[0]*2;
  __xlx_offset_byte_param_in_channels_ch2 = port13.offset[1]*2;
  __xlx_offset_byte_param_in_channels_ch3 = port13.offset[2]*2;
  __xlx_offset_byte_param_in_width = port13.offset[3]*2;
  __xlx_offset_byte_param_in_height = port13.offset[4]*2;
  __xlx_offset_byte_param_out_channels_ch1 = port13.offset[5]*2;
  __xlx_offset_byte_param_out_channels_ch2 = port13.offset[6]*2;
  __xlx_offset_byte_param_out_channels_ch3 = port13.offset[7]*2;
  __xlx_offset_byte_param_out_width = port13.offset[8]*2;
  __xlx_offset_byte_param_out_height = port13.offset[9]*2;
