...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yuv_filter_mac_muladd_8ns_5ns_15ns_15_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_channels_ch1 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_channels_ch2 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_channels_ch3 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_yuv_channels_ch1_din { O 8 vector } p_yuv_channels_ch1_full_n { I 1 bit } p_yuv_channels_ch1_write { O 1 bit } p_yuv_channels_ch1_num_data_valid { I 3 vector } p_yuv_channels_ch1_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_yuv_channels_ch2_din { O 8 vector } p_yuv_channels_ch2_full_n { I 1 bit } p_yuv_channels_ch2_write { O 1 bit } p_yuv_channels_ch2_num_data_valid { I 3 vector } p_yuv_channels_ch2_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_yuv_channels_ch3_din { O 8 vector } p_yuv_channels_ch3_full_n { I 1 bit } p_yuv_channels_ch3_write { O 1 bit } p_yuv_channels_ch3_num_data_valid { I 3 vector } p_yuv_channels_ch3_fifo_cap { I 3 vector } } \
} "
}
