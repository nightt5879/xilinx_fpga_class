...
set C_modelArgList {
	...
	{ in_width int 64 regular  }
	{ in_height int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_channels_ch1","offset": { "type": "dynamic","port_name": "in_channels_ch1","bundle": "control"},"direction": "READONLY"},{"cName": "in_channels_ch2","offset": { "type": "dynamic","port_name": "in_channels_ch2","bundle": "control"},"direction": "READONLY"},{"cName": "in_channels_ch3","offset": { "type": "dynamic","port_name": "in_channels_ch3","bundle": "control"},"direction": "READONLY"},{"cName": "in_width","offset": { "type": "dynamic","port_name": "in_width","bundle": "control"},"direction": "READONLY"},{"cName": "in_height","offset": { "type": "dynamic","port_name": "in_height","bundle": "control"},"direction": "READONLY"},{"cName": "out_channels_ch1","offset": { "type": "dynamic","port_name": "out_channels_ch1","bundle": "control"},"direction": "WRITEONLY"},{"cName": "out_channels_ch2","offset": { "type": "dynamic","port_name": "out_channels_ch2","bundle": "control"},"direction": "WRITEONLY"},{"cName": "out_channels_ch3","offset": { "type": "dynamic","port_name": "out_channels_ch3","bundle": "control"},"direction": "WRITEONLY"},{"cName": "out_width","offset": { "type": "dynamic","port_name": "out_width","bundle": "control"},"direction": "WRITEONLY"},{"cName": "out_height","offset": { "type": "dynamic","port_name": "out_height","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "in_width", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "in_height", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_channels_ch1 sc_in sc_lv 64 signal 1 } 
	{ in_channels_ch2 sc_in sc_lv 64 signal 2 } 
	{ in_channels_ch3 sc_in sc_lv 64 signal 3 } 
	{ in_width sc_in sc_lv 64 signal 4 } 
	{ in_height sc_in sc_lv 64 signal 5 } 
	...
	{ p_yuv_width_din sc_out sc_lv 16 signal 9 } 
	{ p_yuv_width_full_n sc_in sc_logic 1 signal 9 } 
	{ p_yuv_width_write sc_out sc_logic 1 signal 9 } 
	{ p_yuv_width_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ p_yuv_width_fifo_cap sc_in sc_lv 3 signal 9 } 
	{ p_yuv_height_din sc_out sc_lv 16 signal 10 } 
	{ p_yuv_height_full_n sc_in sc_logic 1 signal 10 } 
	{ p_yuv_height_write sc_out sc_logic 1 signal 10 } 
	{ p_yuv_height_num_data_valid sc_in sc_lv 3 signal 10 } 
	{ p_yuv_height_fifo_cap sc_in sc_lv 3 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_width", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "in_width", "role": "default" }} , 
 	{ "name": "in_height", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "in_height", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "8"],
		...
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134", "Port" : "gmem", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			...
			{"Name" : "p_yuv_channels_ch1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134", "Port" : "p_yuv_channels_ch1", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "p_yuv_channels_ch2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134", "Port" : "p_yuv_channels_ch2", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "p_yuv_channels_ch3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134", "Port" : "p_yuv_channels_ch3", "Inst_start_state" : "75", "Inst_end_state" : "76"}]},
			{"Name" : "p_yuv_width", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "p_yuv_width_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_yuv_height", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "p_yuv_height_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.mac_muladd_8ns_7s_8ns_15_4_1_U17", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.mac_muladd_8ns_7ns_8ns_15_4_1_U18", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.mac_muladd_8ns_8s_16s_16_4_1_U19", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.mac_muladd_8ns_5ns_15ns_15_4_1_U20", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.mac_muladd_8ns_8s_16s_16_4_1_U21", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_rgb2yuv_1_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y_fu_134.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16ns_16ns_32_1_1_U35", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "120155", "Max" : "7372955"}
	, {"Name" : "Interval", "Min" : "120155", "Max" : "7372955"}
]}
...
set Spec2ImplPortList { 
	...
	in_width { ap_none {  { in_width in_data 0 64 } } }
	in_height { ap_none {  { in_height in_data 0 64 } } }
	...
	p_yuv_width { ap_fifo {  { p_yuv_width_din fifo_data_in 1 16 }  { p_yuv_width_full_n fifo_status 0 1 }  { p_yuv_width_write fifo_port_we 1 1 }  { p_yuv_width_num_data_valid fifo_status_num_data_valid 0 3 }  { p_yuv_width_fifo_cap fifo_update 0 3 } } }
	p_yuv_height { ap_fifo {  { p_yuv_height_din fifo_data_in 1 16 }  { p_yuv_height_full_n fifo_status 0 1 }  { p_yuv_height_write fifo_port_we 1 1 }  { p_yuv_height_num_data_valid fifo_status_num_data_valid 0 3 }  { p_yuv_height_fifo_cap fifo_update 0 3 } } }
}
