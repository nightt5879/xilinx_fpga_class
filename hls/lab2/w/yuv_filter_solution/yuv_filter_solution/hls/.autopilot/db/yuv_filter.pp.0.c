...
RGB2YUV_LOOP_X:
   for (x=0; x<width; x++) {
#line 14 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution/hls_config.cfg"
...
RGB2YUV_LOOP_Y:
      for (y=0; y<height; y++) {
#line 15 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
...
YUV2RGB_LOOP_X:
   for (x=0; x<width; x++) {
#line 16 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
...
YUV_SCALE_LOOP_X:
   for (x=0; x<width; x++) {
#line 17 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 156 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"

#pragma HLS loop_tripcount min=200 max=1920
YUV_SCALE_LOOP_Y:
      for (y=0; y<height; y++) {
#line 18 "E:/robot/project/xilinx_fpga_class/hls/lab2/w/yuv_filter_solution/hls_config.cfg"
#pragma HLSDIRECTIVE PIPELINE off=true
# 159 "E:/robot/project/xilinx_fpga_class/hls/lab2/yuv_filter.c"
