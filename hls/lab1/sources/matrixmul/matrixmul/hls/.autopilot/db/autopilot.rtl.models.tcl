set SynModuleInfo {
  {SRCNAME matrixmul MODELNAME matrixmul RTLNAME matrixmul IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME matrixmul_flow_control_loop_delay_pipe RTLNAME matrixmul_flow_control_loop_delay_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME matrixmul_flow_control_loop_delay_pipe_U}
    }
  }
}
